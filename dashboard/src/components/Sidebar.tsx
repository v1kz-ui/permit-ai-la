...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className={`w-64 min-h-screen flex-col bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-xl flex-shrink-0
        ...
        <div className="px-6 py-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-white leading-none">PermitAI LA</p>
              <p className="text-xs text-slate-400 mt-0.5">Fire Rebuild Dashboard</p>
            </div>
            {/* Close button on mobile */}
            <button
              onClick={() => setMobileOpen(false)}
              className="ml-auto lg:hidden w-7 h-7 rounded-lg hover:bg-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-colors"
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 px-2 py-2 rounded-xl bg-white/5">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-white truncate">LADBS Staff</p>
              <p className="text-xs text-slate-400 truncate">admin@la.gov</p>
            </div>
...
export function MobileSidebarTrigger() {
  return null; // Hamburger button is rendered directly inside Sidebar as a fixed element
}
