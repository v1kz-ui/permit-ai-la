...
const JARGON_DEFINITIONS: Record<string, string> = {
  ...
  "LAHD": "LA Housing Department — handles multi-family housing compliance and rent stabilization",
  "Cultural Affairs": "Dept. of Cultural Affairs — reviews cultural/archaeological resources and public art requirements",
  "Urban Forestry": "Urban Forestry Division (Public Works) — handles protected tree removal permits and replacement plans",
